...
//Define properties to store values | Define methods to provide functionality 
...
//Identity Operators
//because calsses are reference types we can do compare if  two classes have exactly the same instance
